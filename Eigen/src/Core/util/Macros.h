...
// Does the compiler support variadic templates?
  ...
  && (!defined(__NVCC__) || !EIGEN_ARCH_ARM_OR_ARM64 || (defined __CUDACC_VER_MAJOR__ && __CUDACC_VER_MAJOR__ >= 80000) )
...
#if EIGEN_MAX_CPP_VER>=14 && (__cplusplus > 199711L && defined(__CUDACC_VER_MAJOR__) && (EIGEN_COMP_CLANG || __CUDACC_VER_MAJOR__ >= 70500))
...
#if EIGEN_COMP_MSVC_STRICT && (EIGEN_COMP_MSVC < 1900 ||  defined(__CUDACC_VER_MAJOR__)) // for older MSVC versions, as well as 1900 && CUDA 8, using the base operator is sufficient (cf Bugs 1000, 1324)
